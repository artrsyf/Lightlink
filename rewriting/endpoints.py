...
class WebRTCEndpoint(Endpoint):
    ...
    def __str__(self):
        return f"WebRTCEndpoint ID: {self.elem_id} Session ID: {self.session_id} with sdpOffer: {self.sdp_offer}\n"
    ...
    def process_offer(self, session_desc_offer):
        ...
        if 'resp_success' in sdp_load:
            self.sdp_offer = session_desc_offer
        else:
            print(f"Idiot SDP error: already SDP: {self.sdp_offer}")
            print("////")
            print(sdp_load)
